...
#, fuzzy
 ""
# fuzzy # => "Project-Id-Version: PACKAGE VERSION\nPOT-Creation-Date: 2002-11-19 14:07+0900\nPO-Revision-Date: 2002-11-19 15:00+0900\nLast-Translator: Oota Toshiya <oota@itp.nec.co.jp>\nLanguage-Team: Japanese\nMIME-Version: 1.0\nContent-Type: text/plain; charset=EUC-JP\nContent-Transfer-Encoding: 8bit\n",
 => "",

#: lib/FAQ/OMatic.pm:98 lib/FAQ/OMatic/install.pm:1068
 "Warnings:"
 => "警告:",

#: lib/FAQ/OMatic.pm:112
 "Your Faq-O-Matic would have a title "
 => "インストーラを走らせた時にできる",

#: lib/FAQ/OMatic.pm:113
 "if it had an item 1, which it will when you've run the "
 => "アイテム1を持っているならば、あなたのFaq-O-Maticは",

#: lib/FAQ/OMatic.pm:114
 "installer."
 => "タイトルを持つだろう。",

#: lib/FAQ/OMatic.pm:116 lib/FAQ/OMatic/install.pm:1153
 "Untitled Faq-O-Matic"
 => "未タイトルの Faq-O-Matic",

#: lib/FAQ/OMatic.pm:138 lib/FAQ/OMatic/authenticate.pm:151
 "Log In"
 => "ログイン",
...
#: lib/FAQ/OMatic.pm:145 lib/FAQ/OMatic/Appearance.pm:168
 "Search"
 => "検索",
...
#: lib/FAQ/OMatic.pm:147 lib/FAQ/OMatic/submitPass.pm:152
 "Validate"
 => "認証",

#: lib/FAQ/OMatic.pm:148
 "%0 Permissions for %1"
 => "%1のパーミッションを %0",

#: lib/FAQ/OMatic.pm:149
#, c-format
 "Upload bag for %0 %1"
 => "%0 向けのbagのアップロード %1",
...
#: lib/FAQ/OMatic/Appearance.pm:269 lib/FAQ/OMatic/Item.pm:2088
...
#: lib/FAQ/OMatic/Auth.pm:493
 "the administrator of this Faq-O-Matic"
 => "FAQ-O-Maticの管理者",

#: lib/FAQ/OMatic/Auth.pm:494
...
#: lib/FAQ/OMatic/Auth.pm:509
 "the moderator of the item"
 => "このアイテムのモデレータ",

#: lib/FAQ/OMatic/Auth.pm:513
#, c-format
 "%0 group members"
 => "グループメンバー %0",
...
#: lib/FAQ/OMatic/Item.pm:76
 "New Item"
 => "新しいアイテム",

#: lib/FAQ/OMatic/Item.pm:714
 "Parts"
 => "パート",

#: lib/FAQ/OMatic/Item.pm:838
 "Previous"
 => "前",

#: lib/FAQ/OMatic/Item.pm:856
 "Next"
 => "次",

#: lib/FAQ/OMatic/Item.pm:955 lib/FAQ/OMatic/Item.pm:1369
#: lib/FAQ/OMatic/Item.pm:1553
 "Moderator"
 => "モデレータ",

#: lib/FAQ/OMatic/Item.pm:957
 "(inherited from parent)"
 => "(親から継承)",

#: lib/FAQ/OMatic/Item.pm:975
 "Category Title and Options"
 => "カテゴリのタイトルとオプション",

#: lib/FAQ/OMatic/Item.pm:976
 "Edit Category Permissions"
 => "カテゴリのパーミッションを編集",

#: lib/FAQ/OMatic/Item.pm:977
 "Move Category"
 => "カテゴリを移動",
...
#: lib/FAQ/OMatic/Item.pm:982
 "Answer Title and Options"
 => "回答のタイトルとオプション",

#: lib/FAQ/OMatic/Item.pm:983
 "Edit Answer Permissions"
 => "回答のパーミッションを編集",

#: lib/FAQ/OMatic/Item.pm:984
 "Move Answer"
 => "回答を移動",

#: lib/FAQ/OMatic/Item.pm:985
 "Trash Answer"
 => "回答を廃棄",
...
#: lib/FAQ/OMatic/Item.pm:992 lib/FAQ/OMatic/Item.pm:993
 "Edit %0 Permissions"
 => "%0 のパーミッションを編集",

#: lib/FAQ/OMatic/Item.pm:994
 "Move %0"
 => "%0 を移動",
...
#: lib/FAQ/OMatic/Item.pm:1033
 "Duplicate Answer"
 => "回答の複製",

#: lib/FAQ/OMatic/Item.pm:1034
 "Duplicate Category as Answer"
 => "回答としてカテゴリを複製",

#: lib/FAQ/OMatic/Item.pm:1077
 "Convert to Answer"
 => "回答に変換",

#: lib/FAQ/OMatic/Item.pm:1087
 "Convert to Category"
 => "カテゴリに変換",

#: lib/FAQ/OMatic/Item.pm:1103 lib/FAQ/OMatic/Item.pm:1183
 "New Answer in \"%0\""
 => "\"%0\"中の新しい回答",

#: lib/FAQ/OMatic/Item.pm:1110
 "New Subcategory of \"%0\""
 => "\"%0\"の中の新しいサブカテゴリ",

#: lib/FAQ/OMatic/Item.pm:1136 lib/FAQ/OMatic/Part.pm:348
 "Insert Text Here"
 => "ここでテキストを挿入",

#: lib/FAQ/OMatic/Item.pm:1149 lib/FAQ/OMatic/Part.pm:359
 "Insert Uploaded Text Here"
 => "アップロードしたテキストをここで挿入",

#: lib/FAQ/OMatic/Item.pm:1199
 "Append to This Answer"
 => "この答に追加",

#: lib/FAQ/OMatic/Item.pm:1317
 "This document is:"
 => "このドキュメントは:",

#: lib/FAQ/OMatic/Item.pm:1319
 "This document is at:"
 => "このドキュメントのURLは:",

#: lib/FAQ/OMatic/Item.pm:1363
 "Group %0"
 => "グループ %0",

#: lib/FAQ/OMatic/Item.pm:1367
 "Users giving their names"
 => "ユーザはユーザ名を与えた",

#: lib/FAQ/OMatic/Item.pm:1368
 "Authenticated users"
 => "認証されたユーザ",

#: lib/FAQ/OMatic/Item.pm:1383
 "New Category"
 => "新規カテゴリ",

#: lib/FAQ/OMatic/Item.pm:1385
 "New Answer"
 => "新しい回答",

#: lib/FAQ/OMatic/Item.pm:1389
 "Editing Category <b>%0</b>"
 => "",

#: lib/FAQ/OMatic/Item.pm:1393
...
#: lib/FAQ/OMatic/Item.pm:1428
 "Title:"
 => "タイトル:",

#: lib/FAQ/OMatic/Item.pm:1433
 "<p>New Order for Text Parts:"
 => "<p>テキストパートの新しい順番:",

#: lib/FAQ/OMatic/Item.pm:1445
 "Show attributions from all parts together at bottom"
 => "すべてのパートからの属性を最下部に一緒に表示",

#: lib/FAQ/OMatic/Item.pm:1458 lib/FAQ/OMatic/Item.pm:1617
#: lib/FAQ/OMatic/Part.pm:562 lib/FAQ/OMatic/editBag.pm:122
 "Submit Changes"
 => "変更の送信",

#: lib/FAQ/OMatic/Item.pm:1459 lib/FAQ/OMatic/Item.pm:1618
#: lib/FAQ/OMatic/Part.pm:563 lib/FAQ/OMatic/editBag.pm:123
 "Revert"
 => "復帰",

#: lib/FAQ/OMatic/Item.pm:1479
 "Who can add a new text part to this item:"
 => "このアイテムに新しいパートを追加できる人:",

#: lib/FAQ/OMatic/Item.pm:1481
 "Who can add a new answer or category to this category:"
 => "このカテゴリに新しい答かカテゴリを追加できる人:",

#: lib/FAQ/OMatic/Item.pm:1483
 "Who can edit or remove existing text parts from this item:"
 => "このアイテムから存在するテキストパートを編集又は削除できる人:",

#: lib/FAQ/OMatic/Item.pm:1485
 "Who can move answers or subcategories from this category; or turn this category into an answer or vice versa:"
 => "このカテゴリから回答又はサブカテゴリを移動できる人;又はこのカテゴリを回答又は何かに変更する:",

#: lib/FAQ/OMatic/Item.pm:1487
 "Who can edit the title and options of this answer or category:"
 => "この回答かカテゴリのタイトルとオプションを編集できる人:",

#: lib/FAQ/OMatic/Item.pm:1489
 "Who can use untranslated HTML when editing the text of this answer or category:"
 => "この回答かカテゴリのテキストを編集する時に変換無しのHTMLを使える人:",

#: lib/FAQ/OMatic/Item.pm:1491
 "Who can change these moderator options and permissions:"
 => "モデレータオプションとパーミッションを変更できる人:",

#: lib/FAQ/OMatic/Item.pm:1493
 "Who can create new bags:"
 => "新しいbagを作れる人:",

#: lib/FAQ/OMatic/Item.pm:1495
 "Who can replace existing bags:"
 => "存在する袋を置換できる人:",

#: lib/FAQ/OMatic/Item.pm:1497
 "Who can access the installation/configuration page (use caution!):"
 => "インストール/構成ページにアクセスできる人(使用注意!):",

#: lib/FAQ/OMatic/Item.pm:1499
 "Who can use the group membership pages:"
 => "グループメンバシップページを使える人:",

#: lib/FAQ/OMatic/Item.pm:1516
 "Moderator options for category"
 => "カテゴリのためのモデレータオプション",

#: lib/FAQ/OMatic/Item.pm:1520
 "Moderator options for answer"
 => "回答のためのモデレータオプション",

#: lib/FAQ/OMatic/Item.pm:1525
 "Moderator options for"
 => "右記の項目のためのモデレータオプション ",

#: lib/FAQ/OMatic/Item.pm:1543
 "Name & Description"
 => "名前と説明",

#: lib/FAQ/OMatic/Item.pm:1544
 "Setting"
 => "設定",

#: lib/FAQ/OMatic/Item.pm:1545
 "Setting if Inherited"
 => "継承していた場合の設定",

#: lib/FAQ/OMatic/Item.pm:1554
 "(will inherit if empty)"
 => "(もしも空白ならば継承される)",

#: lib/FAQ/OMatic/Item.pm:1564
 "Send mail to the moderator when someone other than the moderator edits this item:"
 => "モデレータ以外のだれかがこのアイテムを編集した時にメールをモデレータに送る:",

#: lib/FAQ/OMatic/Item.pm:1570
 "No"
 => "いいえ",
...
#: lib/FAQ/OMatic/Item.pm:1570 lib/FAQ/OMatic/Item.pm:1611
 "undefined"
 => "未定義",

#: lib/FAQ/OMatic/Item.pm:1575
 "Permissions"
 => "パーミッション",

#: lib/FAQ/OMatic/Item.pm:1597
 "Relax: New answers and subcategories will be moderated "
 => "緩和: 新しい回答とサブカテゴリは、その新しいアイテムを編集",

#: lib/FAQ/OMatic/Item.pm:1598
 "by the creator of the item, allowing that person full "
 => "するための完全な自由を人々に許可することをアイテムの作者によって",

#: lib/FAQ/OMatic/Item.pm:1599
 "freedom to edit that new item."
 => "モデレートされる。",

#: lib/FAQ/OMatic/Item.pm:1600
 "Don't Relax: new items will be moderated by "
 => "緩和しない: 新しいアイテムは、このアイテムの",

#: lib/FAQ/OMatic/Item.pm:1601
 "the moderator of this item."
 => "モデレータによってモデレートされる。",

#: lib/FAQ/OMatic/Item.pm:1606 lib/FAQ/OMatic/Item.pm:1610
 "Relax"
 => "緩和",
...
#: lib/FAQ/OMatic/Item.pm:1606
 "Inherit"
 => "|継承|",

#: lib/FAQ/OMatic/Item.pm:1640 lib/FAQ/OMatic/Item.pm:1654
 "(system default)"
 => "(システム既定値)",

#: lib/FAQ/OMatic/Item.pm:1646
 "defined in"
 => "右記で定義",

#: lib/FAQ/OMatic/Item.pm:1725
#, c-format
 "File %0 seems broken."
 => "ファイル %0 が壊れているように見える。",

#: lib/FAQ/OMatic/Item.pm:2019
 "Category"
 => "カテゴリ",

#: lib/FAQ/OMatic/Item.pm:2020
 "Answer"
 => "回答",

#: lib/FAQ/OMatic/Item.pm:2090
 ...
 => "だれかが編集フォームを受け取ってから回答又はカテゴリを変更したか、フォームを二回提出した",

#: lib/FAQ/OMatic/Item.pm:2092
#, c-format
 "Please %0 and start again to make sure no changes are lost. Sorry for the inconvenience."
 => "%0 と変更しない分が失われないように、再度スタート。不便を詫びる。",

#: lib/FAQ/OMatic/Item.pm:2095
 "(Sequence number in form: %0; in item: %1)"
 => "(アイテム %1 中のフォーム: %0 のシーケンス番号)",

#: lib/FAQ/OMatic/Part.pm:272
 "Edit This Text"
 => "このテキストを編集",

#: lib/FAQ/OMatic/Part.pm:283
 "Duplicate This Text"
 => "このテキストを複製",

#: lib/FAQ/OMatic/Part.pm:294 lib/FAQ/OMatic/Part.pm:307
 "Remove This Text"
 => "このテキストを削除",

#: lib/FAQ/OMatic/Part.pm:319
 "Replace %0 with new upload"
 => "%0 を新しいアップロードしたもので置換",

#: lib/FAQ/OMatic/Part.pm:326
 "Select bag to replace with new upload"
 => "アップロードで置換するbagを選択",

#: lib/FAQ/OMatic/Part.pm:335
 "Upload New Bag Here"
 => "新しいbagをここでアップロード",

#: lib/FAQ/OMatic/Part.pm:500
 "Upload file:"
 => "ファイルをアップロード:",

#: lib/FAQ/OMatic/Part.pm:505
 "Warning: file contents will <b>replace</b> previous text"
 => "警告: ファイルの内容は以前のテキストで <b>置換</b> ",

#: lib/FAQ/OMatic/Part.pm:512
 "Hide Attributions"
 => "属性を隠す",

#: lib/FAQ/OMatic/Part.pm:515
 "Format text as:"
 => "書式テキストは:",

#: lib/FAQ/OMatic/Part.pm:525
 "Directory"
 => "ディレクトリ",

#: lib/FAQ/OMatic/Part.pm:532
 "Natural text"
 => "自然なテキスト",

#: lib/FAQ/OMatic/Part.pm:536
 "Monospaced text (code, tables)"
 => "1つのスペースのテキストText (コード,テーブル)",

#: lib/FAQ/OMatic/Part.pm:551
 "Untranslated HTML"
 => "変換されないHTML",

#: lib/FAQ/OMatic/Part.pm:702 lib/FAQ/OMatic/addItem.pm:102
#: lib/FAQ/OMatic/install.pm:1166 lib/FAQ/OMatic/submitAnsToCat.pm:67
 "Answers in this category:"
 => "このカテゴリの回答",

#: lib/FAQ/OMatic/SearchMod.pm:312
 "days"
 => "日",
...
#: lib/FAQ/OMatic/addItem.pm:102 lib/FAQ/OMatic/install.pm:1166
...
#: lib/FAQ/OMatic/appearanceForm.pm:62 lib/FAQ/OMatic/install.pm:797
 "expert editing commands"
 => "上級向け編集コマンド",

#: lib/FAQ/OMatic/appearanceForm.pm:66 lib/FAQ/OMatic/install.pm:802
 "name of moderator who organizes current category"
 => "現在のカテゴリを管理するモデレータ名",

#: lib/FAQ/OMatic/appearanceForm.pm:70 lib/FAQ/OMatic/install.pm:807
 "last modified date"
 => "最後に変更した日時",
...
#: lib/FAQ/OMatic/appearanceForm.pm:86 lib/FAQ/OMatic/install.pm:812
 "attributions"
 => "属性",
...
#: lib/FAQ/OMatic/appearanceForm.pm:94 lib/FAQ/OMatic/install.pm:817
...
#: lib/FAQ/OMatic/authenticate.pm:89
 ...
 => "このパートは生のHTMLを含んでいる。不正なHTMLを含むページを防止するため、モデレータは %0 のみが編集出来るように指定している。もしも %0 ならば、このフォームで自分自身を認証する必要がある。",
...
#: lib/FAQ/OMatic/authenticate.pm:101
 ...
 => "このアイテムはソースとディストネーション親アイテム両方を編集できる人のみが移動できる。",
...
#: lib/FAQ/OMatic/authenticate.pm:122
 ...
 => "もしも既に本日ログインしていたならば、認証用トークンの有効期限切れである。再度ログインが必要。",
...
#: lib/FAQ/OMatic/changePass.pm:52
 ...
 => "安全に保管も転送もされていないので、他の場所ではパスワードを<b>使ってはいけない</b>。",
...
#: lib/FAQ/OMatic/editBag.pm:81
 ...
 => "<b>%1</>中のパート %0 中に表示するために新しいbagをアップロード",
...
#: lib/FAQ/OMatic/editBag.pm:98
 ...
 => "バッグ名はファイル名として使用されるため、名前は英数字と下線(_)、ハイホン(-)とピリオド(.)に制限される。また、意味のある拡張子(例えば .gif)は伝達されるため、Webブラウザはデータに対して何をしたらいいかが分かる。",

#: lib/FAQ/OMatic/editBag.pm:99
 "Hint: Leave blank and Bag Data filename will be used."
 => "ヒント: 空白とBagデータファイル名を残すことは使うことが出来る",
...
#: lib/FAQ/OMatic/editPart.pm:172
 ...
 => "もしも、このテキストを後で編集又は削除する必要がある場合、[Appearance] ページで上級編集コマンドを有効にする必要がある。",
...
#: lib/FAQ/OMatic/install.pm:183
 ...
 => "もしも、CGIスタブを別ディレクトリを示すように変更したいなら、スクリプトを編集し、",

#: lib/FAQ/OMatic/install.pm:186
 "click here to use the new location"
 => "新しいローケーションを使うためにここでクリック",
...
#: lib/FAQ/OMatic/install.pm:188
 ...
 => "FAQ-O-Matic はファイルを2つのディレクトリに格納する。<p><b>meta/</b>ディレクトリパスはCGIスタブ($0)中にエンコードされ、以下を含む:",
...
#: lib/FAQ/OMatic/install.pm:189
 ...
 => "<ul><li><b>config</b>ファイルは稼働状況以外の、どこにFAQ-O-Maticの全てがあるかを記述する。それはなぜCGIスタブがどこに meta/ があるかを知る必要があると言う事であり、その構成の残りを指し示す。<li><b>idfile</b> はユーザ識別情報を保持する。そのため、meta/ はWeb サーバ経由でアクセスできてはいけない。<li><b>RCS/</b>サブディレクトリはFAQの各アイテムを追跡する。<li>種々のヒントファイルはFAQ-O-Matic実行時に使われる。それらは自動的に再生成される。</ul>",
...
#: lib/FAQ/OMatic/install.pm:190
 ...
 => "<p><b>serve/</b>ディレクトリは3つのサブディレクトリ: <b>item/</b>, <b>cache/</b>と<b>bags/</b>を含む。それらのディレクトリは、FAQ-O-Matic-CGI によって作成され、一般化されるが、webサーバから(CGI起動なして)直接アクセス可能でなければならない。).",
...
#: lib/FAQ/OMatic/install.pm:191
 ...
 => "<ul><li>serve/item/ は FAQ-O-Matic形式のソースファイルのみ保持し、それは、ユーザが入力したテキストとFAQ中の階層構造の回答とカテゴリをエンコードする。それらのファイルは、他のFAQ-O-Maticがそれをミラーする時は、webサーバを経由してのみ(というよりはCGI経由)アクセスできる。<li>serve/cache/ ディレクトリは自動的に生成された、HTMLバージョンのFAQの回答とカテゴリのキャッシュを保持する。もしも可能ならば、CGIはサーバ負荷の軽減のために、キャッシュを指し示す。(CGIのヒットは通常のファイルのロードよりははるかにコストがかかる。)<li>serve/bags/ はイメージファイルとその他の情報を含む。その他の情報のbagはFAQアイテム中にリンクできる(イメージの場合)。</ul>",

#: lib/FAQ/OMatic/install.pm:203 lib/FAQ/OMatic/install.pm:218
#: lib/FAQ/OMatic/install.pm:277 lib/FAQ/OMatic/install.pm:625
 "I couldn't create <b>%0</b>: %1"
 => "<b>%0</b>を作成できない: %1",

#: lib/FAQ/OMatic/install.pm:207 lib/FAQ/OMatic/install.pm:222
#: lib/FAQ/OMatic/install.pm:628
 "Created <b>%0</b>."
 => "<b>%0</b> を作成した。",

#: lib/FAQ/OMatic/install.pm:210 lib/FAQ/OMatic/install.pm:225
#: lib/FAQ/OMatic/install.pm:631
 "I don't have write permission to <b>%0</b>."
 => "<b>%0</b>に対する書き込み許可を持っていない。",
...
#: lib/FAQ/OMatic/install.pm:491
 ...
 => "未参照のbag(FAQアイテムにリンクされていない)をチェック",
...
#: lib/FAQ/OMatic/install.pm:503
 "fsck (check and repair tree structure)"
 => "fsck(木構造の検査と修復)",

#: lib/FAQ/OMatic/install.pm:516
 "The Faq-O-Matic modules are version %0."
 => "Faq-O-Maticのモジュールのバージョンは %0。",

#: lib/FAQ/OMatic/install.pm:635
 "I wasn't able to change the permissions on <b>%0</b> to 755 (readable/searchable by all)."
 => "<b>%0</b> のパーミッションを 755 にできない(全てのユーザに 読み/検索を許可)。",

#: lib/FAQ/OMatic/install.pm:650 lib/FAQ/OMatic/install.pm:651
 "updated config file:"
 => "構成ファイルを更新:",

#: lib/FAQ/OMatic/install.pm:658
 "Redefine configuration parameters to ensure that <b>%0</b> is valid."
 => "<b>%0</b> の有効化を確実にするために構成ファイルパラメータを再定義。",

#: lib/FAQ/OMatic/install.pm:670
 "Jon made a mistake here; key=%0, property=%1."
 => "Jonはここでミスをした; key=%0, property=%1.",

#: lib/FAQ/OMatic/install.pm:699
 "<b>Mandatory:</b> System information"
 => "<b>命令:</b> システム情報",

#: lib/FAQ/OMatic/install.pm:702
 "Identity of local FAQ-O-Matic administrator (an email address)"
 => "ローカルの FAQ-O-Matic管理者の識別(メールアドレス)",
...
#: lib/FAQ/OMatic/install.pm:718
 ...
 => "作成サイトのURLのプロトコル、ホストとポート番号部分。これはURLのリンクの構築に使われる。最後の '/'を省略しなさい。例:<tt>http://www.dartmouth.edu</tt>",

#: lib/FAQ/OMatic/install.pm:721
 ...
 => "このCGIスクリプトにアクセスするためのURLのパスの部分で、'/'で始まり、'?'以降の任意のパラメータを省略。例:<tt>/cgi-bin/cgiwrap/jonh/faq.pl</tt>",
...
#: lib/FAQ/OMatic/install.pm:724
 ...
 => "FAQ-O-Maticがアイテムファイル、イメージとその他のもののbagファイルを保持し、作成したHTMLファイルをキャッシュするディレクトリ。このディレクトリはhttpサーバ経由でアクセスできねばならない。たとえば、/home/faqomatic/public_html/fom-serve/である。",
...
#: lib/FAQ/OMatic/install.pm:726
 ...
 => "<b>\$serveDir</b>中のファイルにアクセスするのに必要なURLのプレフィックスのパス。これはサーバのrootからの相対パスでなければならない(http://hostname:portは省略できるが、先行する'/' は含まなければならない。)。また、'/'で終る必要がある。",

#: lib/FAQ/OMatic/install.pm:729
 "<i>Optional:</i> Miscellaneous configurations"
 => "<i>任意:</i> その他の構成設定",

#: lib/FAQ/OMatic/install.pm:734
 "Select the display language."
 => "表示言語を選択",

#: lib/FAQ/OMatic/install.pm:739
...
#: lib/FAQ/OMatic/install.pm:743
 ...
 => "もしもこのパラメータが設定されると、このFAQは与えられたURLのミラーとなる。URLはマスターFAQ-O-MaticのCGIスクリプトのベースネームでなければならない。",
...
#: lib/FAQ/OMatic/install.pm:745
 ...
 => "それぞれのページの先頭に挿入されるHTMLフラグメント。会社のロゴを配置するのに使える。",

#: lib/FAQ/OMatic/install.pm:747 lib/FAQ/OMatic/install.pm:760
 ...
 => "もしもフィールドが <tt>file=</tt> で始まるならば、テキストはメタディレクトリ中の名前付けられたファイルから来る。それ例外は、このフィールドはverbatimを含む。",
...
#: lib/FAQ/OMatic/install.pm:755
 ...
 => "テーブル中の<tt>width=</tt> タグ。もしも <b>\$pageHeader</b> が <tt>align=left</tt>ならば、これを空白にしてもよい。",

#: lib/FAQ/OMatic/install.pm:758
 "An HTML fragment appended to the bottom of each page. You might use this to identify the webmaster for this site."
 => "各ページの末尾に追加されるHTMLフラグメント。このサイトのWeb管理者を表示するのに使える。",
...
#: lib/FAQ/OMatic/install.pm:763
 ...
 => "FAQ-O-Maticが、管理者に警告を送ろうとする時に、送る先のメールアドレス(通常は\$adminAuthと同一)",

#: lib/FAQ/OMatic/install.pm:765
 "If true, FAQ-O-Matic will mail the log file to the administrator whenever it is truncated."
 => "もしも真ならば、FAQ-O-Maticはログファイルが縮められた時には必ずメールする。",

#: lib/FAQ/OMatic/install.pm:768
 "User to use for RCS ci command (default is process UID)"
 => "RCS ci コマンドを使うユーザ(既定値ではプロセスのUID)",

#: lib/FAQ/OMatic/install.pm:772
 "Links from cache to CGI are relative to the server root, rather than absolute URLs including hostname:"
 => "ホスト名を含む絶対URLというよりはサーバルートからCGIキャッシュへの相対リンク:",

#: lib/FAQ/OMatic/install.pm:776
 ...
 => "mailto: リンクは jonhATdartmouthDOTedu (擬似的)、jonh(名前のみ)又はメールアドレスが完全に抑圧される(隠蔽)ように書き換えることが出来る。",

#: lib/FAQ/OMatic/install.pm:780
 ...
 => "認証クッキーが有効な秒数。このクッキーはURLに保存され、ブラウザヒストリファイルから検索できる。そのため、あまり早くタイムアウトにならないように設定。",

#: lib/FAQ/OMatic/install.pm:784
 "Number of days that trash sits in the trash category before maintenance cleans it up. '0' lets it stay forever."
 => "保守時に削除してしまう前に、ごみがゴミ箱(trash)カテゴリ中に居座っている日数。'0'を指定すると永遠に保持される。",

#: lib/FAQ/OMatic/install.pm:787
 "<i>Optional:</i> These options set the default [Appearance] modes."
 => "<i>任意:</i> これらのオプションが[Appearance]モードの既定値に設定。",

#: lib/FAQ/OMatic/install.pm:792
 "Page rendering scheme. Do not choose 'text' as the default."
 => "ページレンダリングスキーム。'text'を既定値として選んではならない。",

#: lib/FAQ/OMatic/install.pm:820
 "<i>Optional:</i> These options fine-tune the appearance of editing features."
 => "<i>任意:</i> これらのオプションは編集機能向けのの見栄えに良く調整されている。",

#: lib/FAQ/OMatic/install.pm:823
 "The old [Show Edit Commands] button appears in the navigation bar."
 => "古い[編集コマンドを表示]ボタンはナビゲータバーにある。",

#: lib/FAQ/OMatic/install.pm:827
 "Navigation links appear at top of page as well as at the bottom."
 => "ナビゲーションリンクは末尾と同じようにページの先頭にある。",

#: lib/FAQ/OMatic/install.pm:831
 "Hide [Append to This Answer] and [Add New Answer in ...] buttons."
 => "[この回答を追加]と[新しい回答を追加...]ボタンを隠す。",

#: lib/FAQ/OMatic/install.pm:836
 "Editing commands appear with neat-o icons rather than [In Brackets]."
 => "[ブラケット中]というよりは編集コマンドは neat-oアイコンと一緒にある。",

#: lib/FAQ/OMatic/install.pm:839
 "<i>Optional:</i> Other configurations that you should probably ignore if present."
 => "<i>任意:</i> もしも存在するならば、その他の構成は無視すべきである。",

#: lib/FAQ/OMatic/install.pm:843
 "Draw Item titles John Nolan's way."
 => "アイテムタイトルをJohn Nolan流で描画。",

#: lib/FAQ/OMatic/install.pm:847
 "Hide sibling (Previous, Next) links"
 => "(前、次)兄弟リンクを隠す",

#: lib/FAQ/OMatic/install.pm:851
 "Use DBM-based search databases. Faster on machines with non-broken DBM."
 => "DBMベースの検索データベースを使う。壊れていないDBMのマシンのものを使うより早い。",

#: lib/FAQ/OMatic/install.pm:963
 "This is a command, so only letters, hyphens, and slashes are allowed."
 => "これはコマンドなので、英数字、ハイホンとスラッシュのみが有効。",

#: lib/FAQ/OMatic/install.pm:1022
 "If this is your first time installing a FAQ-O-Matic, I recommend only filling in the sections marked <b>Mandatory</b>."
 => "もしも最初のFAQ-O-Maticのインストールならば、<b>命令(Mandatory)</b>とマークされたセクションのみを埋める事を推奨。",

#: lib/FAQ/OMatic/install.pm:1026
 "Define"
 => "定義",

#: lib/FAQ/OMatic/install.pm:1069
 "You should <a href=\"%0\">go back</a> and fix these configurations."
 => "<a href=\"%0\">戻る</a> に戻り、それらの構成を修正しなければならない。",

#: lib/FAQ/OMatic/install.pm:1072
 "Rewrote configuration file."
 => "構成ファイルを再書き込み。",

#: lib/FAQ/OMatic/install.pm:1086
 "%0 (%1) has an internal apostrophe, which will certainly make Perl choke on the config file."
 => "%0 (%1) は内部にアポストロフィがあり、それは構成ファイル上で確実にPerlを止める。",

#: lib/FAQ/OMatic/install.pm:1090 lib/FAQ/OMatic/install.pm:1096
 "%0 (%1) doesn't look like a fully-qualified email address."
 => "%0 (%1) は完全に記述されている電子メールアドレスではない。",

#: lib/FAQ/OMatic/install.pm:1102 lib/FAQ/OMatic/install.pm:1107
 "%0 (%1) isn't executable."
 => "%0 (%1) は実行できない。",

#: lib/FAQ/OMatic/install.pm:1124
#, c-format
 "%0 has funny characters."
 => "%0 には不正な文字がある。",

#: lib/FAQ/OMatic/install.pm:1159
 ...
 => "FAQ-O-Maticに名前を付けるために、[見栄え]ページで上級編集コマンドを見えるように使い、[カテゴリタイトルとオプションの編集]をクリック",

#: lib/FAQ/OMatic/install.pm:1169 lib/FAQ/OMatic/install.pm:1181
#: lib/FAQ/OMatic/install.pm:1193
 "Created category \"%0\"."
 => "\"%0\"カテゴリを作成した。",

#: lib/FAQ/OMatic/install.pm:1171 lib/FAQ/OMatic/install.pm:1183
#: lib/FAQ/OMatic/install.pm:1195
 "<b>%0</b> already contains a file '%1'."
 => "<b>%0</b> はすでにファイル '%1' を含んでいる。",

#: lib/FAQ/OMatic/install.pm:1233
 "Copied %0 items from <tt>%1</tt> to <tt>%2</tt>."
 => "%0 アイテムを、<tt>%1</tt>から<tt>%2</tt>へコピーした。",

#: lib/FAQ/OMatic/install.pm:1290
 "Attempting to install cron job:"
 => "cronジョブのインストールを試みる:",

#: lib/FAQ/OMatic/install.pm:1338
 "I replaced this old crontab line, which appears to be an older one for this same FAQ:"
 => "この同じFAQの古い物に見えるような、古いcrontab行をリプレースした:",

#: lib/FAQ/OMatic/install.pm:1347
 "I thought I installed a new cron job, but it didn't appear to take."
 => "新しいcronジョブをインストールしたが、そのように見えないと思う。",

#: lib/FAQ/OMatic/install.pm:1349
#, c-format
 "You better add %0 to some crontab yourself with <b><tt>crontab -e</tt></b>"
 => "%0 をいくつかのcrontabに、<b><tt>crontab -e</tt></b> を使って御自身で追加した方が良い。",

#: lib/FAQ/OMatic/install.pm:1355
 "Cron job installed. The maintenance script should run hourly."
 => "Cronジョブをインストールした。管理スクリプトを毎時動かすべきである。",

#: lib/FAQ/OMatic/install.pm:1411
 "Use the <u>%0</u> links to change the color of a feature."
 => "<u>%0</u> リンクを、機能の色を変更するために使う。",

#: lib/FAQ/OMatic/install.pm:1425
 "An Item Title"
 => "アイテムの題名",

#: lib/FAQ/OMatic/install.pm:1433
 ...
 => "通常のパートはどのようにほとんどのコンテンツを見せるかである。テキストの色はこの背景上でほとんど快適に読める。",

#: lib/FAQ/OMatic/install.pm:1435 lib/FAQ/OMatic/install.pm:1447
#: lib/FAQ/OMatic/install.pm:1474
 "A new link"
 => "新しいリンク",

#: lib/FAQ/OMatic/install.pm:1436 lib/FAQ/OMatic/install.pm:1448
#: lib/FAQ/OMatic/install.pm:1478
 "A visited link"
 => "訪れたリンク",

#: lib/FAQ/OMatic/install.pm:1438 lib/FAQ/OMatic/install.pm:1450
#: lib/FAQ/OMatic/install.pm:1483
 "A search hit"
 => "検索にヒット",

#: lib/FAQ/OMatic/install.pm:1446
 "A directory part should stand out"
 => "ディレクトリ部分はstand outすべき",

#: lib/FAQ/OMatic/install.pm:1470
 "Regular text"
 => "通常のテキスト",

#: lib/FAQ/OMatic/install.pm:1495
...
#: lib/FAQ/OMatic/search.pm:106
 ...
 => "検索索引がデータベースの最新の変更以来更新されていないため、結果は不完全な可能性がある。",
...
#: lib/FAQ/OMatic/submitPass.pm:49
 ...
 => "電子メールアドレスは 'name\@some.domain' の形でなければならない。",
